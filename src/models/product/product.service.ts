...
export class ProductService {
  ...
  async create(createProductDto: CreateProductDto){
    ...
    const specifications = createProductDto.specifications.map(spec => ({
      name: spec.name,
      value: spec.value,
    }));
...
async findOneBySellerId(sellerId: string): Promise<Product[]> {
  return this.prisma.product.findMany({
...
async findProductsByCategory(categoryId: string): Promise<Product[]> {
  ...
  async update(
    ...
    const specifications = updateProductDto.specifications.map(spec => ({
      name: spec.name,
      value: spec.value,
    }));
    return this.prisma.product.update({
      ...
      data: { 
        ...
        longDescription:updateProductDto.shortDescription,
